class BankAccount:
  ...
  def deposit(self,amount):
    if amount>0:
      ...
      print("Deposited Rs.{}. No balance: Rs.{}".format(amount,self.__account_balance))
    else:
...
account.initial(account_number="649143852",account_holder_name= "Meenakshi",initial_balance=5000.0)
account.display()
